...
# UpWatch public status
Test-Endpoint "UpWatch /status" "https://upwatch.online/status" "UpWatch"

# Admin bundle — stale if old Lovable stub
try {
...
# Monitor runner — needs production deploy with Supabase env
try {
