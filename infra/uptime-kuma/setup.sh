...
echo ""
echo "Homepage auto-sync (recommended):"
echo "  Kuma → Settings → API Keys → create key with Metrics access"
echo "  Add as GitHub secret KUMA_METRICS_API_KEY (deploy syncs to Worker)"
echo "  Then every Kuma monitor appears on upwatch.online automatically"
echo ""
